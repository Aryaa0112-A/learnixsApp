...
<body>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-sm-none d-lg-inline-block" style="font-size:15px;">Hello, 
                                <?php 
                                    $user = $this->db->get_where('admin', ['email' => 
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <div>
                            <a href="<?= base_url('admin') ?>" style="font-size: 21px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center"><i style="font-size: 30px;" class="fas fa-book"></i> Learnix's Education</a>
                        </div>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= base_url('admin/add_mapel') ?>">Tambah Data Mapel</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-header">Management Jadwal</li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-calendar"></i><span>Jadwal</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('admin/data_jadwal') ?>">Data Jadwal</a></li>
                                <li><a class="nav-link" href="<?= base_url('admin/add_jadwal') ?>">Tambah Jadwal</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <?php echo $this->db->count_all('jadwal'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- SweetAlert untuk menampilkan notifikasi login berhasil -->
