...
<head>
    ...
    <title>Data Mata Pelajaran - Learnix's Education</title>
    <!-- General CSS Files -->
...
<body><br><br>
    ...
    <tr>
      <td align="center">
        <span style="line-height: 2; font-weight: bold; ">
          <h2>SEKOLAH MENENGAH KEJURUAN
          <br>TEKNOLOGI PILAR BANGSA</h2>
        </span>
      </td>
    </tr>
  </table>
  ...
  <hr class="line-title"> 
  <p align="center">
    <B>LAPORAN DATA MATA PELAJARAN </B><br>
  </p>
  <table align="center" class="table table-bordered" border="1" style="width:95%;">
    <thead>
        <tr bgcolor="#DCDCDC">
            <th>No</th>
        ...
        <?php if (!empty($mapel_list)): ?>
            <?php $no = 1; foreach ($mapel_list as $mapel): ?>
                <tr>
                    ...
                    <td>
                        <?php
                            // Filter guru_mapel for the current subject
                            $guru_terkait = array_filter($guru_mapel, function($gm) use ($mapel) {
                                return isset($gm->nama_mapel) && $gm->nama_mapel == $mapel->nama_mapel;
                            });
  ...
  <table border="0" width="100%">
                      <tr>
                        ...
                        <td width="50%"></td>
                        <td width="25%" align="center">Tangerang, <?php echo tgl_indo($date) ?><br><br> Hormat Kami</td>
                      </tr>
                        <td height="100px"></td>
                        <td></td>
                        <td></td>
...
<script type="text/javascript">
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaF/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous">
    </script>
