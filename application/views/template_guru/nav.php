...
<head>
    ...
    <title>guru Dashboard - Learnix's</title>
    <!-- General CSS Files -->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= base_url('guru/kelas_saya') ?>">Kelas Saya</a></li>
                            </ul>
                        </li>
                        <li class="menu-header">Jadwal</li>
                        <li><a class="nav-link" href="<?= base_url('guru/data_jadwal') ?>"><i class="fas fa-calendar"></i> <span>Jadwal Saya</span></a></li>
                    </ul>
                </aside>
            </div>
            <!-- End Sidebar -->