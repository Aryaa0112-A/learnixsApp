                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <p class="card-text">Jumlah Siswa yang terdaftar di Learnix's Education sekarang adalah
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('guru/detail_siswa/' . $u->id_siswa); ?>" class="btn btn-success"> <i class="fa fa-address-card"></i> Detail</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
