        ...
        <div class="login-wrapper">
            <div class="login-brand">
                ...
                <div class="login-brand-content">
                    ...
                    <p>Silahkan login untuk masuk ke halaman guru dan mengelola pembelajaran digital Anda.</p>
                </div>
                
                <div class="login-brand-footer">
                    <div class="illustration">
                        <img src="https://cdn-icons-png.flaticon.com/512/2995/2995620.png" alt="teacher illustration">
                    </div>
            ...
            <div class="login-form">
                <div class="login-form-header">
                    <h4>Login Guru</h4>
                    <p>Silahkan masukkan email dan password untuk mengakses dashboard guru.</p>
                </div>
                ...
                <form method="post" action="<?= base_url('welcome/guru') ?>">
