                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i>
                                <span>Materi</span></a>
                            <ul class="dropdown-menu">
                            <li><a class="nav-link" href="<?= base_url('guru/materi') ?>">Data Materi</a>
                            </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('guru/kelas_saya') ?>">Kelas Saya</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-file-alt"></i>
                                <span>Tugas</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('guru/tugas') ?>">Daftar Tugas</a>
                                </li>
                                <li><a class="nav-link" href="<?= base_url('guru/tambah_tugas') ?>">Tambah Tugas</a>
                                </li>
                                <li><a class="nav-link" href="<?= base_url('guru/soal_pilihan_ganda') ?>">Daftar Soal PG</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-calendar"></i>
                                <span>Jadwal</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('guru/data_jadwal') ?>">Jadwal Saya</a>
                                </li>
                            </ul>
                        </li>
                </aside>
