            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data tugas Learnix's Education</h2>
                            <hr>
                            <p class="card-text">Jumlah tugas yang terdaftar di Learnix's Education sekarang adalah
