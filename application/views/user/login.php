...
<body>
        ...
        <div class="login-wrapper">
            <div class="login-brand">
                ...
                <div class="login-brand-content">
                    ...
                    <p>SMK Teknologi Pilar Bangsa menyediakan platform e-learning untuk mendukung proses belajar mengajar yang lebih interaktif dan efisien.</p>
                </div>
                
                <div class="login-brand-footer">
                    <div class="illustration">
                        <img src="https://cdn-icons-png.flaticon.com/512/3976/3976625.png" alt="e-learning illustration">
                    </div>
            ...
            <div class="login-form">
                <div class="login-form-header">
                    <h4>Login Siswa</h4>
                    <p>Silahkan masukkan email dan password untuk mengakses platform e-learning.</p>
                </div>
                ...
                <form method="post" action="<?= base_url('welcome/validateLogin') ?>">
                    <div class="login-form-group">
                        ...
                        <div class="input-icon-wrap">
                            ...
                            <input id="email" type="email" class="login-form-control" name="email" tabindex="1" required autofocus value="<?= set_value('email'); ?>">
                        </div>
                    </div>
                    ...
                    <div class="login-form-group">
                        ...
                        <div class="input-icon-wrap">
                            ...
                            <input id="password" type="password" class="login-form-control" name="password" tabindex="2" required>
    ...
    <?php if ($this->session->flashdata('fail-verify')) : ?>
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Verifikasi Gagal!',
                text: 'Token atau email tidak valid!',
                showConfirmButton: false,
                timer: 2500
            })
        </script>
